...
- Bumps `software.amazon.awssdk:identity-spi` from 2.42.18 to 2.44.4
- Bumps `com.fasterxml.jackson.core:jackson-annotations` from 2.20 to 2.21
...
### Removed
- Remove Apache Spark 2.x (sql-20) module support ([#700](https://github.com/opensearch-project/opensearch-hadoop/pull/700))
...
- Bumps `com.google.protobuf:protobuf-java` from 4.28.2 to 4.34.0
- Bumps `commons-logging:commons-logging` from 1.3.4 to 1.3.6
...
- Bumps `com.gradleup.shadow` from 8.3.6 to 9.3.2
